...
const Navbar = () => {
  ...
  return (
    <div className='max-w-[1640px] mx-auto flex justify-between items-center p-4'>
        ...
        {nav ?  <div className='fixed top-0 left-0 h-screen w-full bg-black/80 z-10'></div> : ''}

        {/* Side drawer menu  */}
        <div className={nav ? 'fixed left-0 top-0 w-[300px] bg-white h-screen z-10 duration-300':'fixed left-[-100%] top-0 w-[300px] bg-white h-screen z-10 duration-300'}>
            <AiOutlineClose 
            onClick={()=> setNav(!nav)}
            size={30} 
            ...
            <h2 className='text-2xl p-4'>
                Food <span className='font-bold'>Bazar</span>
            </h2>
